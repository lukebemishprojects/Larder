...
public record S3BackendConfiguration(Identifier<Repository> id, Identifier<RepositoryBackend> backend, String bucket, String prefix) implements Model.OneToMany<Repository, Identifier<RepositoryBackend>> {
