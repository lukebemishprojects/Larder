...
public record RepositoryBackend(UUID id, RepositoryBackendType type) implements Model.Object {
    public static final Representation<RepositoryBackend> REPRESENTATION = Representation.build((it, id) -> {
